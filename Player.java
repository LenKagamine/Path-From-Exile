...
public class Player extends MapObject{
	...
	if(!attacking) stabbing = true; //Don't stab while shooting; laser bug
    }
	...
	left = right = up = down = flinching = jumping = falling = attacking = gliding = stabbing = swinging = shooting = false;
    }
    public void reset(){
	health = maxHealth;
	mana = maxMana;
